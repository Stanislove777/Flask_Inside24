...
class Inside24TestCase(unittest.TestCase):
    ...
    def test_message_save_error(self):
    ...
    # Позитивный тест эндпоинта для получения сообщения с командой вывода истории последних пользовательских сообщкний
    ...
    # Позитивный тест эндпоинта для получения сообщения с командой вывода истории последних пользовательских сообщкний (несуществующая команда)
    def test_message_history_error(self):
